...
const EN: Dict = {
  ...
  "mb.status.active": "active",
  "mb.status.deleted": "deleted",
  "mb.status.disabled": "disabled",
  "mb.status.unknown": "unknown",
...
const ZH: Dict = {
  ...
  "view.mailboxes.eyebrow": "Claw 邮箱",
  "view.mailboxes.title": "Claw 邮箱",
  ...
  "mb.row.delete": "删除",
  "mb.status.active": "正常",
  "mb.status.deleted": "已删除",
  "mb.status.disabled": "已停用",
  "mb.status.unknown": "未知",
  "mb.rules.unknown": "未知",
